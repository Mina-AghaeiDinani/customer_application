...
public class SignUpActivity extends AppCompatActivity {
                            ...
                            FirebaseDatabase.getInstance().getReference("CustomersProfile")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(SignUpActivity.this, "Verify your current location...", Toast.LENGTH_LONG).show();
                                        finish();
                                    } else {
    ...
    private void sendUserData() {
        ...
        CustomersProfile customersProfile = new CustomersProfile(txt_Name.getText().toString().trim(), txt_Phone.getText().toString().trim(), txt_Mail.getText().toString().trim(), txt_Description.getText().toString().trim(), String.valueOf(image_uri));

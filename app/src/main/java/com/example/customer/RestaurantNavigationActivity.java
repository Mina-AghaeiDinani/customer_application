...
public class RestaurantNavigationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReferenceLocations2=FirebaseDatabase.getInstance().getReference("CustomersLocation")
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid());
        mReferenceLocations2.addValueEventListener( new ValueEventListener() {
            @Override
        ...
        mReferenceLocations.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (i = 0; i < restaurantLocations.size(); i++) {
                    ...
                    distance = CalculationByDistance(lat, Lng, restaurantLocations.get(i).getLatLng().latitude, restaurantLocations.get(i).getLatLng().longitude);
         ...
         fusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                            myPositionMarker.setPosition(new LatLng(lat, Lng));
                        }
                    }
                });   */
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       // Log.e("lat m lng",lat.toString()+Lng.toString());

        // mMap.addMarker(place1);

        //mMap.addMarker(place2);
//        MarkerOptions a = new MarkerOptions().position(myposition).title("My position");
       // MarkerOptions b=new MarkerOptions().position( new LatLng( lat,Lng ) ).title( "correct one" );
       // mMap.addMarker( b );
